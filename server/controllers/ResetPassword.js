...
//generate token and insert token into user data
...
// //reset password  by useing the token saved in user info
...
exports.resetPasswordToken = async (req, res) => {
	try {
		...
		const url = `http://http://localhost:3000/update-password/${token}`;
